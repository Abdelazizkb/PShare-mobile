            ...
            <View style={tw`h-full w-full items-center justify-center bg-white`}>
              <View style={tw`h-3/7 w-full items-center justify-end`}>
                ...
                <View style={tw`w-full items-center  mt-4 rounded-lg` } >
                    <Text  style={tw` text-gray-700 font-bold text-4xl`}>Bienvenue <Text  style={tw`text-bgreen font-bold text-4xl`}>PShare</Text></Text>
                    <Text  style={tw` text-gray-700  text-xl my-2`}> Toutes vos données médicales</Text>
                    <Text  style={tw` text-gray-700  text-xl `}>  en un seul clic</Text>
                </View>
              <View style={tw`w-4/6  flex-row bg-bgreen items-center justify-end border-3 border-bgreen rounded-lg mt-10 shadow-lg overflow-hidden`}>
                <Pressable style={tw`w-1/2 items-center  ` } >
                    <Text  style={tw`w-full text-center text-black font-bold  bg-white py-3`} onPress={() => navigation.navigate('login')}>Connexion</Text>
                </Pressable>
                <Pressable style={tw`w-1/2 items-center ` } >
                    <Text  style={tw`text-white font-bold py-3 `} onPress={() => navigation.navigate('signup')}>S'inscrir</Text>
                </Pressable>
              </View>
